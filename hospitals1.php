...
$resultSet = $mysqli->query("select pat_id, city, state, Avg(stay_length) as stay, AVG(total_accharges) as acc, Avg(total_charges) as charg 
from texas where nip=$nip and age=$age and sex=$gen 
